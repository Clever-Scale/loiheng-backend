                    ...
                    <div class="card-body" style="padding: 10px 30px">
                        ...
                        <div class="table-responsive">
                                    ...
                                    @else
                                        @foreach ($customers as $key => $customer)
                                            <tr>
                                                ...
                                                <td><img src="{{ $customer->profile_img ? $customer->profile_img : asset('assets/img/images.jpg') }}"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center" style="height: 100%">
                                                        ...
                                                        <div class="px-2 ">
                                                            {{ \Carbon\Carbon::create($customer->created_at)->toFormattedDateString() }}
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                            ...
                            <div class="d-flex justify-content-between align-items-center py-2">
                                <div>
                                    <p><b>Showing:</b> {{ count($customers) }} </p>
                                </div>
                                <div>
    ...
    <script>
        $(document).ready(function() {
            $("#myInput").keypress(function(e) {
                ...
                if (e.which == 13) {
                    location.replace(
                        `/customers?${limit ? 'limit='+limit : ''}${key ? '&key='+key : ''}`
                    );
                }
            });
